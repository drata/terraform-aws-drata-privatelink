...
output "private_dns_verification_state" {
  description = "Verification state reported by AWS: pendingVerification, verified or failed. Consumers cannot enable private DNS until this reads verified. If it later stops reading verified, existing connections survive but new ones are refused."
